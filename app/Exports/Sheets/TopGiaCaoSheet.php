...
class TopGiaCaoSheet implements FromCollection, WithTitle, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    public function title(): string
    {
        return 'SP giá cao nhất';
    }

    public function collection()
    {
        return Product::orderBy('gia', 'desc')->take(10)->get();
    }
