...
<div class="container py-5">
    <nav class="mb-4" aria-label="breadcrumb"><a href="{{ route('home') }}">Trang chủ</a> / Điều khoản sử dụng</nav>
    <div class="row justify-content-center"><article class="col-lg-9">
        <h1 class="page-title text-start">Điều khoản sử dụng</h1>
        <div class="alert alert-info">Trang này chưa được lập chỉ mục vì điều khoản giao dịch, quyền và nghĩa vụ của các bên cần được chủ shop xác nhận trước khi áp dụng.</div>
