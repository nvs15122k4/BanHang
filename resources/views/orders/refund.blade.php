        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-dark text-white py-3">
                    <h5 class="mb-0 text-uppercase fw-bold" style="letter-spacing: 1px;">Cung cấp thông tin hoàn tiền</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('orders.submitRefund', $order) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Số tiền hoàn trả</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Tên ngân hàng</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Số tài khoản</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Tên chủ tài khoản</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Nội dung bổ sung (nếu có)</label>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-dark py-3 fw-bold text-uppercase" style="letter-spacing: 1px; border-radius: 0;">
                                <i class="fas fa-paper-plane me-2"></i>Gửi thông tin
                            </button>
                            <a href="{{ route('orders.show', $order) }}" class="btn btn-outline-secondary py-3 fw-bold text-uppercase" style="letter-spacing: 1px; border-radius: 0;">Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
