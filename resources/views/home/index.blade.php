...
<section class="hero-section">
    <div class="hero-bg" id="heroSlider">
        ...
        <div class="hero-bg-item active" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184415/santimvien/assets/ubyplekaaxjry7xihqmw.jpg')"></div>
        <div class="hero-bg-item" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184418/santimvien/assets/whzqdu9jphyykpyjafro.jpg')"></div>
        <div class="hero-bg-item" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184422/santimvien/assets/hou4wjkuk1tnddxugfvj.jpg')"></div>
    </div>
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                <div class="category-card">
                    <div class="category-img" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184427/santimvien/assets/yasgrjanwrnswwk5oxg9.jpg')"></div>
            ...
            <div class="col-md-4">
                <div class="category-card">
                    <div class="category-img" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184430/santimvien/assets/moxcvgjovqebnew3bf8x.jpg')"></div>
                    <div class="category-overlay"></div>
                    <div class="category-content">
            ...
            <div class="col-md-4">
                <div class="category-card">
                    <div class="category-img" style="background-image: url('https://res.cloudinary.com/***REMOVED***/image/upload/v1782184434/santimvien/assets/gdxd5e1ck3x3jewovluz.jpg')"></div>
                    <div class="category-overlay"></div>
                    <div class="category-content">
